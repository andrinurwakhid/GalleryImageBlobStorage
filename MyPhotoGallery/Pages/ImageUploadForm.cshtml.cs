...
namespace MyPhotoGallery.Pages
{
    public class ImageUploadFormModel : PageModel
    {
        ...
        const string BLOB_CONTAINER_NAME = "blobscontainerdicoding";
        ...
        public async Task OnGetAsync()
        {
            ...
            storageAccount = CloudStorageAccount.Parse(_configuration.GetConnectionString("AzureStorageConnectionString"));
